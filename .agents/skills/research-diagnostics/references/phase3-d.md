...
`phase3-diagnose` writes an immutable evidence directory. Obtain explicit user authorization and confirm the exact output directory before running it or producing a diagnostic bundle.
