...
```text
<repo-python> -m qlib_platform.research.workflow.quickstart COMMAND
```
...
```text
<repo-python> -m qlib_platform.research.reporting.summary <research_matrix.json>
```
...
& $RepoPython -m qlib_platform.research.reporting.summary data\output\quickstart\<RUN>\research_matrix.json
