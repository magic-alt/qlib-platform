...
from tushare_qlib.live_inference import LiveInferenceResult
from tushare_qlib.settings import Paths, Settings
from tushare_qlib.signal_health import SignalHealthReport
...
def test_daily_signal_full_call_path_is_idempotent(tmp_path: Path, monkeypatch):
    ...
    monkeypatch.setattr(
        "tushare_qlib.daily_signal_runner.run_daily_sync",
