...
def test_trade_plan_uses_next_official_open_day(tmp_path: Path, monkeypatch):
    ...
    pd.DataFrame(
        {"cal_date": pd.to_datetime(["2026-08-06", "2026-08-07", "2026-08-08", "2026-08-10"]), "is_open": [1, 1, 0, 1]}
