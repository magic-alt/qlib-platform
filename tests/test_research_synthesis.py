...
from qlib_platform.research.reporting.synthesis import (
    RECOMMENDATIONS,
...
from qlib_platform.research.studies.synthesis import (
...
def _spec():
    return load_phase1_synthesis_spec("configs/synthesis/ashare_research_synthesis_v1.yaml")
...
def test_synthesis_builds_immutable_auditable_bundle_and_propagates_known_industry_gap(tmp_path: Path):
    ...
    kwargs = {
        ...
        "synthesis_path": "configs/synthesis/ashare_research_synthesis_v1.yaml",
        "output_root": tmp_path / "output",
    }

    first = run_research_synthesis(settings, **kwargs)
    second = run_research_synthesis(settings, **kwargs)
    ...
    with pytest.raises(ValueError, match="checksum mismatch"):
        run_research_synthesis(settings, **kwargs)
...
def test_phase1_synthesis_cli_requires_all_four_studies():
    ...
    assert args.command == "research-synthesize"
    assert args.synthesis == "configs/synthesis/ashare_research_synthesis_v1.yaml"
