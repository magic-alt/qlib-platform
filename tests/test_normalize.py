...
def test_adjustment_identity():
    ...
    raw = pd.DataFrame({
        ...
        "open": [10.0, 5.1], "high": [10.5, 5.3], "low": [9.8, 5.0], "close": [10.0, 5.2],
        "vol": [1000.0, 2000.0], "amount": [1000.0, 2000.0], "pct_chg": [0.0, 4.0],
        "adj_factor": [1.0, 2.0], "paused": [0.0, 0.0], "is_st": [0.0, 0.0],
