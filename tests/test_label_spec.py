...
from qlib_platform.research.workflow.train_select import build_dataset
...
def test_label_values_match_with_feature_store_on_and_off(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "qlib_platform.research.workflow.train_select.handler_class", lambda pack: _MiniResearchHandler
    )
    ...
    monkeypatch.setattr("qlib_platform.research.features.store._raw_features", load_raw_features)
